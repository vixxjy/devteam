            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add Thought of the Term</h4>
                            </div>
                            <div class="content">
                                @if($errors->any())
                                ...
                                @endif
                                <form action="{{ route('Thoughtterm.store')}}" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-md-6">
...
<!--                                    </div>-->
                                    <div class="text-center">
                                        ...
                                        <button type="submit" class="btn btn-info btn-fill btn-wd">Add Thought of the Term</button>
                                    </div>
                                   ...
                                   <table class="table table-bordered table-striped table-condensed" id="table" >
                                        ...
                                        <tbody>
                                           @foreach($thoughtterms as $thoughtterm)
                                            <tr class="">
                                                <td>{{$thoughtterm->id}}</td>
                                                <td>{{ $thoughtterm->title}}</td>
                                                <td>{{ $thoughtterm->bible_quote }}</td>
                                                <td>{{ $thoughtterm->verse }}</td>
                                                <td><a href="{{route('thoughtterm.edit',['id' => $thoughtterm->id])}}"><button id="edit-modal" class="edit-modal btn btn-info">
                                                        <span class="glyphicon glyphicon-edit"></span> Edit
                                                    </button></a>
                                                   
                                                    <a href="{{ route('thoughtterm.delete', $thoughtterm->id) }}" onclick="return confirm('Do you really want to delete This?')">
