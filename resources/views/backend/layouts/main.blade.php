...
<head>
	...
	<link rel="icon" type="{{ asset('dash/image/png')}}" sizes="96x96" href="{{ asset('dash/assets/img/favicon.png')}}">
    ...
    <link href="{{ asset('dash/assets/css/paper-dashboard.css')}}" rel="stylesheet"/>
    ...
    <link href="{{ asset('dash/assets/css/themify-icons.css')}}" rel="stylesheet">
     @yield('style')
</head>
<body>
@yield('content')
    ...
    <!--   Core JS Files   -->
    <script src="{{ asset('dash/assets/js/jquery.min.js')}}" type="text/javascript"></script>
	<script src="{{ asset('dash/assets/js/bootstrap.min.js')}}" type="text/javascript"></script>

	<!--  Checkbox, Radio & Switch Plugins -->
	<script src="{{ asset('dash/assets/js/bootstrap-checkbox-radio.js')}}"></script>
	...
	<script src="{{ asset('dash/assets/js/paper-dashboard.js')}}"></script>
