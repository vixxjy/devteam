...
<head>
    ...
    <link rel="stylesheet" href="staug/css/style.css">
...
<body>
        ...
        <div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; bottom: #transparent-sticky-navbar">
            <nav class="uk-navbar-container" uk-navbar style="position: relative; z-index: 980;">
                <div class="uk-navbar-left">
                    <a class="uk-navbar-item uk-logo" href="#"><img src="staug/img/logo.png" alt=""></a>
                    <ul class="uk-navbar-nav">
                    ...
                    <ul class="uk-navbar-nav nav1">
                        <li>
                            <a class="uk-text-center uk-flex-wrap" href="#">
                                <img src="staug/img/admissions.png" alt="" class="nav-img">
                                <span class="uk-width-1-1@s">Admissions</span>
                            </a>
                        </li>
                        <li>
                            <a class="uk-text-center uk-flex-wrap" href="#">
                                <img src="staug/img/portal.png" alt="" class="nav-img">
                                <span class="uk-width-1-1@s">Portal</span>
                            </a>
                        </li>
                        <li>
                            <a class="uk-text-center uk-flex-wrap" href="#">
                                <img src="staug/img/liturgy.png" alt="" class="nav-img">
                                <span class="uk-width-1-1@s">Liturgy</span>
                            </a>
                        </li>
                        <li>
                            <a class="uk-text-center uk-flex-wrap" href="#">
                                <img src="staug/img/school.png" alt="" class="nav-img">
    ...
    <header class="uk-overflow-hidden">
        <div class="uk-position-relative" uk-slideshow="animation: fade; autoplay: true">
            ...
            <ul class="uk-slideshow-items">
                <li>
                    <img src="staug/img/slide4.jpg" alt="" uk-cover>
                </li>
                <li>
                    <img src="staug/img/slide3.jpg" alt="" uk-cover>
                </li>
                <li>
                    <img src="staug/img/slide2.jpg" alt="" uk-cover>
                </li>
                <li>
                    <img src="staug/img/slide1.jpg" alt="" uk-cover>
                </li>
            </ul>

            <div class="uk-position-bottom-center uk-position-small">
                <ul class="uk-thumbnav">
                    <li uk-slideshow-item="0"><a href="#"><img src="staug/img/slide4.jpg" width="100" alt=""></a></li>
                    <li uk-slideshow-item="1"><a href="#"><img src="staug/img/slide3.jpg" width="100" alt=""></a></li>
                    <li uk-slideshow-item="2"><a href="#"><img src="staug/img/slide2.jpg" width="100" alt=""></a></li>
                    <li uk-slideshow-item="3"><a href="#"><img src="staug/img/slide1.jpg" width="100" alt=""></a></li>
                </ul>
    ...
    <main class="body">
        <div class="uk-container uk-container-small">
            <div class="uk-child-width-1-5@m cards uk-grid-small" uk-grid>
                <a href="#">
                    <div class="uk-card">
                    <img src="staug/img/admission.png" alt="admission">
                    <span>ADMISSION</span>
                    </div>
                </a>
                <a href="#">
                    <div class="uk-card">
                    <img src="staug/img/calender.png" alt="calender">
                    <span>CALENDER</span>
                    </div>
                </a>
                <a href="#">
                    <div class="uk-card">
                    <img src="staug/img/history.png" alt="history">
                    <span>HISTORY</span>
                    </div>
                </a>
                <a href="#">
                    <div class="uk-card">
                    <img src="staug/img/gallery.png" alt="gallery">
                    <span>GALLERY</span>
                    </div>
                </a>
                <a href="#">
                    <div class="uk-card">
                    <img src="staug/img/contact.png" alt="contact">
                    <span>CONTACT</span>
                    </div>
                </a>
            </div>
            ...
            <div class="container uk-text-center">
                ...
                <div class="uk-child-width-1-2@m" uk-grid>
                    <div class="uk-padding uk-child-width-1-2@m uk-text-left bests" uk-grid>
                        <div>
                            <img src="staug/img/best-teach.png" width="70" alt="">
            ...
            <div class="uk-grid-collaps uk-margin-large-bottom" uk-grid>
                ...
                <div class="vid-card uk-width-2-3@m uk-padding-remove">
                    <a class="uk-margin-bottom" uk-toggle="target: .hideme; animation: uk-animation-fade; queued: true; duration: 300">
                        <img class="uk-width-1-1@m hideme" src="staug/img/whyUs.png" alt="">
                    </a>
                    <iframe class="hideme"
            ...
            <div class="n&e-updates container">
                ...
                <div class="uk-child-width-1-4@m uk-grid-match uk-grid-small uk-margin-large-bottom" uk-grid>
                    <div>
                        <div class="uk-card uk-card-default">
                            <div class="uk-card-media-top">
                                <img src="staug/img/news1.png" alt="">
                            </div>
                    ...
                    <div>
                        <div class="uk-card uk-card-default">
                            <div class="uk-card-media-top">
                                <img src="staug/img/news2.png" alt="">
                            </div>
                            <div class="uk-card-body uk-padding-small">
                    ...
                    <div>
                        <div class="uk-card uk-card-default">
                            <div class="uk-card-media-top">
                                <img src="staug/img/news3.png" alt="">
                            </div>
                            <div class="uk-card-body uk-padding-small">
                    ...
                    <div>
                        <div class="uk-card uk-card-default">
                            <div class="uk-card-media-top">
                                <img src="staug/img/news4.png" alt="">
                            </div>
                            <div class="uk-card-body uk-padding-small">
                                <h6 class="font-600">Combined with a handful</h6>
                                <time datetime="2016-04-01T19:00">April 01, 2016</time>
    ...
    <script src="staug/js/uikit.min.js"></script>
    <script src="staug/js/uikit-icons.min.js"></script>
</body>
</html>